...
<body class="bg-gradient-to-tl from-fage-300 to-fage-500 min-h-screen flex flex-col items-center justify-center">
    <div class="grid lg:grid-cols-3 grid-cols-2 border-2 gap-0.5 bg-black lg:m-0 mx-4">
        <a class="bg-orange-400 hover:bg-amber-700 p-12 py-16 text-center text-2xl flex flex-col items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="120" viewBox="0 0 640 640">
